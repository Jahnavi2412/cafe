...
class homepage():
    ...
    def registerUser(self):
        ...
        if check1 is None:
             ...
             messagebox.showerror("showwarning", "Warning fill valid emailid")
        elif check2 is None:
             print("invalid email id")
             messagebox.showerror("showwarning", "Warning fill valid pasword")
        elif check3 is None:
            print("Invalid Number")
            messagebox.showerror("showwarning", "Warning fill valid phone number")
        else:
